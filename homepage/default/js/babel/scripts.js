...
var c1 = [{
  elem: '.slide0 .cta1',
  url: '/sale/girls-clothing/view-all',
  text: '<span>shop</span> girl'
}, {
  elem: '.slide0 .cta2',
  url: '/sale/boys-clothing/view-all',
  text: '<span>shop</span> boy'
}, {
  elem: '.slide0 .cta3',
  url: '/sale/tween-girls-clothing/view-all',
  text: '<span>shop</span> tween'
}, {
  elem: '.slide0 .cta4',
  url: '/sale/baby-girl-clothes/view-all',
  text: '<span>shop</span> baby girl'
}, {
  elem: '.slide0 .cta5',
  url: '/sale/baby-boy-clothes/view-all',
  text: '<span>shop</span> baby boy'
}, {
  elem: '.slide0 .cta6',
  url: '/sale/newborn-clothing/view-all',
