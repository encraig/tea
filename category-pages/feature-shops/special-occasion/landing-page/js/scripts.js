...
var addCell = function(dpSrc, dpAlt) {
  ...
  var cells = [{
      num: 4,
      alt: 'Foo dogs symbolize prosperity, succuess, and guardianship',
      ext: '.png',
      sku: '',
    },
    {
      num: 12,
      alt: 'inspired by the 700-year-old tradition of Vietnamese hand embroidery',
      ext: '.png',
      sku: ''
    },
    {
    ...
    {
      num: 26,
      alt: 'Sparkle & shine in metallic print',
      ext: '.gif',
      sku: ''
    },
    {
      num: 33,
      alt: 'the lotus is the national flower of Vietnam',
      ext: '.png',
      sku: ''
    },
  ];
  ...
  $.each(cells, function(i, val) {
    ...
    //mobile
      ...
      elem = '<div class="single-item-box content-cell" data-sku="' + val.sku + '"><img src="' + url + val.num + val.ext + '" alt="' + val.alt +
