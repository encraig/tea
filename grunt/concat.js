module.exports = function(grunt){
	return {
      ...
      cell: {
        files: {
          //desktop
          'content-cell-take-over/<%= cell.name %>/<%= cell.date %>/build/local-d.html': ['local-templates/desktop/header-get.html','local-templates/build/full-page.html','local-templates/desktop/footer-get.html'],
          //mobile
          'content-cell-take-over/<%= cell.name %>/<%= cell.date %>/build/local-m.html': ['local-templates/mobile/header-get.html','local-templates/build/full-page.html','local-templates/mobile/footer-get.html'],
        }
      },
