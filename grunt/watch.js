module.exports = function(grunt){
	...
	return {
      ...
      Cell: {
        files: ['content-cell-take-over/<%= cell.name %>/<%= cell.date %>/css/*.less', 'content-cell-take-over/<%= cell.name %>/<%= cell.date %>/dev/*.html', 'content-cell-take-over/<%= cell.name %>/<%= cell.date %>/js/*.js'],
