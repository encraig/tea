...
$(document).ready(function(){
  ...
  var shoeBrands = [
    {brand:'yosi samra', url:'https://www.yosisamra.com/pages/size-chart'},
    {brand:'vans', url: '/static/vans-shoe-size-guide'},
    {brand:'elephantito',url:'https://www.elephantito.com/pages/sizing'},
    {brand:'old soles',url:'https://www.oldsoles.com.au/features/kids/'},
    {brand:'superga',url:'https://www.superga-usa.com/content.jsp?pageName=SizeGuide'},
    {brand:'livie & luca',url:'https://www.livieandluca.com/pages/size-chart'},
    {brand:'native',url:'https://www.nativeshoes.com/'},
    {brand:'saltwater sandal',url:'https://saltwater-sandals.com/sizing-calculator/'},
    {brand:'umi',url:'http://www.umishoes.com/shop/includes/sizeChart.html'},
    {brand:'onitsuka tiger',url:'http://www.onitsukatiger.com/us/en-us/size-guide'},
    {brand:'asics',url:'http://www.asics.com/us/en-us/shoe-size-guide'},
...
/*-----------------------------------------------------------------------------------------*/ 
  ...
  var adjustMeasureCSS = function(){
    ...
    if(catVal == 'shoes + accessories' || catVal == 'pajamas'){
      //desktop
      if($(window).width() > 737){
        $('.measure-tips').css({minHeight: '0', padding:'0 0 33px 0'}); 
      }
      //mobile
      if($(window).width() < 737){
      ...
      //desktop
      if($(window).width() > 737){
        $('.measure-tips').css({minHeight: '420px', padding:'196px 0 0 0'});
      }
      //mobile
      if($(window).width() < 737){
        $('.measure-tips').css({minHeight:'290px', backgroundPosition: 'center -23px'});
      ...
      //desktop
      if($(window).width() > 737){
        $('.measure-tips').css({minHeight: '360px', padding:'196px 0 0 0'}); 
      }
      //mobile
      if($(window).width() < 737){
        $('.measure-tips').css({minHeight:'237px', backgroundPosition: 'center -21px'});
        //reset the height of .measure-tips div
        $('.measure-tips div').css('height', '0px');  
      }
    }
